...
## Куки
`cookies` в веб-разработке - это небольшие фрагменты данных, которые веб-сайты сохраняют на устройстве пользователя. Они играют ключевую роль в современном интернете, выполняя различные функции. 
